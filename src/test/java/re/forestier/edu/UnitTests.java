...
public class UnitTests {
    ...
    void testUnknownAvatar(){
        Exception exception = assertThrows(UnknownAvatarException.class, () -> {
 ...
 /* Les tests ajoutés dans cette partie sont fait pour essayer de passer l'étape 'Mutation' à 100% */
    ...
    public void testprintPlayerInventory() {
        ...
        String actualOutput = Affichage.printPlayer(p);
    ...
    void testObjectGetters() {
        RPG object = new RPG("Lookout Ring", "Prevents surprise attacks", 1, 50);
    ...
    void testGetObjectByName() {
        RPG object = ObjectList.getObject("Lookout Ring");
    ...
    void testGetObjectByNameNotFound() {
        RPG object = ObjectList.getObject("Nonexistent Item");
        assertNull(object);
    }
    ...
    void testGetRandomObject() {
        RPG randomObject = ObjectList.getRandomObject(2);
    ...
    void testGetRandomObjectNoMatching() {
        RPG randomObject = ObjectList.getRandomObject(0);
    ...
    void testSellObjectSuccess() {
        ...
        RPG objectToSell = ObjectList.getObject("Lookout Ring");
    ...
    void testSellObjectBuyerLacksMoney() {
        ...
        Exception exception = assertThrows(NoMoneyException.class, () -> {
            seller.sellObject("Lookout Ring", buyer);
        });
    ...
    void testSellObjectBuyerLacksWeight() {
        ...
        seller.addObject("Lookout Ring");
        Exception exception = assertThrows(NoFreeWeightException.class, () -> {
            seller.sellObject("Lookout Ring", buyer);
        });
